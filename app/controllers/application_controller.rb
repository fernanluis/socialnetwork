class ApplicationController < ActionController::Base
  ...
  def configure_permitted_parameters
    devise_parameter_sanitizer.permit(:sign_up, keys: [:name, :last_name, :username, :image])
    devise_parameter_sanitizer.permit(:account_update, keys: %i[:name, :last_name, :username, :image])
  end
